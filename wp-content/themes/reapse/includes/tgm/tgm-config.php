...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name' => 'Reapse Plugin', // The plugin name
            'slug' => 'theme-plugin', // The plugin slug (typically the folder name)
            'source' => 'http://uddog.net/theme/demo/wordpress/reapse/plugin/theme-plugin.zip', // The plugin source
            //'source' => get_template_directory().'/plugins/tb-services.zip', // The plugin source
